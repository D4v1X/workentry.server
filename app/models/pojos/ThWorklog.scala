...
class ThWorklog(
  ...
  def setWorklogId(worklogId : Integer) : Unit = {
  ...
  override def toString : String = {
    val sb = new StringBuilder("ThWorklog (")

    sb.append(id)
    sb.append(", ").append(worklogId)
